<?php
    ...
    $connect = new mysqli("localhost", "root", "", "ITP_HR");  
        ...
        $sql= "INSERT INTO travel_request(Tfrom,Tto,Tdate,EndDate,Vehicle,priority,description,Emp_id)
        values ('$Tfrom','$Tto','$Tdate','$EndDate','$Vehicle','$priority','$description','$E_idp')";
