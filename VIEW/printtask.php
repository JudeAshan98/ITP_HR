...
<div class="container" role="main">
  ...
  $sql = "SELECT k.Fin_Rating AS Fin_Rating,e.F_name AS F_name, k.kpi_id AS kpi_id,k.kpi_name AS kpi_name,k.rating AS rating  FROM kpi k,employee e where e.D_id=(select D_id from employee where Emp_id=$login_session) AND e.emp_id = k.emp_id";
